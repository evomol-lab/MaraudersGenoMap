...
THREADS=16 # Number of threads to use for MEGAHIT
...
multiqc . --ai -o 04_MultiQC_Report

## --- Step 5: De Novo Assembly (MEGAHIT) ---
echo "### STEP 5: Assembling normalized reads with MEGAHIT ###"
megahit -1 03_Normalized_Reads/${PREFIX}_1_normalized.fastq.gz \
        -2 03_Normalized_Reads/${PREFIX}_2_normalized.fastq.gz \
        --num-cpu-threads ${THREADS} \
        -o 05_MEGAHIT_Assembly_${PREFIX}

## --- Pipeline Complete ---
echo "✅ Pipeline finished successfully!"
echo "=> Final QC report is in '04_MultiQC_Report/multiqc_report.html'"
echo "=> Assembly results are in the '05_MEGAHIT_Assembly_${PREFIX}' directory."
echo "=> The final assembly is named 'final.contigs.fa' inside that directory."
